...
**Output convention**: Write the precedent chain analysis to `bcc-output/YYYY-MM-DD-<slug>/precedent-chain-<topic>.md` and give in chat only a 3–5 line summary with the file path. See `skills/shared/output-conventions.md`.
