...
**Output convention**: Write the adversarial review to `bcc-output/YYYY-MM-DD-<slug>/04-adversarial-review.md` and give in chat only a 3–5 line summary with the file path. See `skills/shared/output-conventions.md`.
