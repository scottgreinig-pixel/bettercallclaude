...
**Output convention**: Write triage reports to `bcc-output/YYYY-MM-DD-<slug>/nda-triage-<doc>.md`. In batch mode, also write a summary table. Give in chat only the verdict (GREEN/YELLOW/RED) with a 2–3 line summary per NDA. See `skills/shared/output-conventions.md`.
