...
**Output convention**: Write the full strategy memo to `bcc-output/YYYY-MM-DD-<slug>/03-strategy.md` and give in chat only a 3–5 line summary with the file path. See `skills/shared/output-conventions.md`. You can also say: "fammi un'analisi strategica dettagliata" to get the full file output.
